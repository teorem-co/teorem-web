        ...
        <>
            <div className="flex flex--col">
                {!hideBanner && userRole === RoleOptions.Tutor && profileProgressState && !profileProgressState.verified && (
                    ...
                    >
                        <p className="ml-6 align-self-center type--wgt--bold">
                            {t(`TUTOR_VERIFIED_NOTE.TITLE`)} {t(`TUTOR_VERIFIED_NOTE.DESCRIPTION`)}
                        </p>
                ...
                <div className="layout">
                    ...
                    <div id="main_layout" onScroll={(e) => debouncedScrollHandler(e.target)} className="layout__main">
                        {props.children}
                    </div>
                </div>
            </div>
