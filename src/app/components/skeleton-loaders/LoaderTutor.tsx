...
const LoaderTutor = () => (
    <div className="flex--primary p-6">
        <ContentLoader className="mr-6" speed={2} width={594} height={157} viewBox="0 0 594 157" backgroundColor="#f3f3f3" foregroundColor="#ecebeb">
        ...
        <ContentLoader speed={2} width={195} height={154} viewBox="0 0 195 154" backgroundColor="#f3f3f3" foregroundColor="#ecebeb">
