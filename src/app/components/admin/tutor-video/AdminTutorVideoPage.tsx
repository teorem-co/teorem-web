import { IAdminTutorVideoInformation, useLazyGetAdminTutorVideoInformationQuery } from '../../../../services/tutorService';
...
export const AdminTutorVideoPage = () => {
    ...
    const fetchData = async () => {
        ...
        const tutorResponse = await getAdminTutorVideos(params).unwrap();
        setLoadedTutorVideosInfo(tutorResponse.content);
    };

    useEffect(() => {
        console.log('Data changed: ', loadedTutorVideosInfo);
    }, [loadedTutorVideosInfo]);
        ...
        <MainWrapper>
            <div className="card--secondary">
                ...
                {loadedTutorVideosInfo.length > 0 ? (
                    <div className="card--secondary__body tutor-managment-card tutor-list">
                        <table className="tutors-table">
                            ...
                            <tbody className="table-scrollable-tbody">
                                ...
                                {loadedTutorVideosInfo.map((tutorVideoInfo) => {
                                    return <AdminTutorVideoItem fetchData={fetchData} tutorVideoInfo={tutorVideoInfo} />;
                                })}
                            </tbody>
                        </table>
                    </div>
