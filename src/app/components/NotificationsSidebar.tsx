...
const NotificationsSidebar = (props: Props) => {
    const { sideBarIsOpen, title, children, closeSidebar } = props;
    ...
    return (
        <div className="pos--abs">
            ...
            <div className={`notification-sidebar sidebar ${!sideBarIsOpen ? 'notification-sidebar--close' : ''}`}>
                <div className="flex--primary flex--shrink">
                    <div className="type--color--secondary"></div>
                    <div>
