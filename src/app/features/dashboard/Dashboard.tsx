...
const Dashboard = () => {
  ...
  const userData = useAppSelector((state) => state.user);
    ...
    const fetchData = async () => {
        ...
        const groupedDashboardData: IGroupedDashboardData = groupBy(upcoming, (e) => moment(e.startTime).format('DD MMM YYYY'));
      ...
      const groupedRequestData: IGroupedDashboardData = groupBy(requests, (e) => moment(e.startTime).format('DD MMM YYYY'));
