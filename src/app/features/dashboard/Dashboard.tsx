...
} from './upcoming-lessons/LessonRescheduleRequestItem';
import { BookingRequestItem } from './upcoming-lessons/BookingRequestItem';
import {
  PendingRescheduleRequestItem,
} from './upcoming-lessons/PendingRescheduleRequestItem';
  ...
  return (
    <>
      {!isMobile && modalActive && userRole !== RoleOptions.Child ? (
        <TutorialModal title={t('TUTOR_INTRO.MODAL.TITLE')}
                       body={t('TUTOR_INTRO.MODAL.BODY')} skip={skipTutorial}
                       start={startTutorial} />
      ) : (
        <></>
      )}
        ...
        <>
          {userRole === RoleOptions.Parent && childless && modal ? (
            <div>
              ...
              <div
                className='flex field__w-fit-content align--center flex--center'>
                <>
                  <div>
                    {/* HEADER */}
                    <div style={{ margin: '40px' }} className='flex'>
                      <div className='flex flex--center flex--shrink w--105'>
                        <CircularProgress className='progress-circle ml-1'
                                          progressNumber={50} />
                      </div>
                      <div className='flex flex--col flex--jc--center ml-6'>
                        <h4 className='signup-title ml-6 text-align--center'>
                          {t('ADD_CHILD.PART_1')}
                          <span
                            className='primary-color'>{t('ADD_CHILD.PART_2')}</span>
                        </h4>
                      </div>
                    </div>
                            ...
                            >
                              <div className='dash-wrapper__item__element'>
                                <div className='flex--primary cur--pointer'>
                                  <div>
                                    <div
                                      className='mb-1'>{t('ADD_CHILD.TITLE')}</div>
                                    <div
                                      className='type--color--secondary'>{t('ADD_CHILD.DESCRIPTION')}</div>
                                  </div>
                                  <i
                                ...
                                return (
                                  ...
                                  >
                                    <div
                                      ...
                                      <div
                                        className='flex--primary cur--pointer'>
                                        <div className='flex flex--center'>
                                          <ImageCircle
                                            initials={`${x.firstName.charAt(0)}`} />
                                          <div className='flex--grow ml-4'>
                                            <div
                                              className='mb-1'>{x.firstName}</div>
                                            <div
                                        ...
                                        <i
                                          className='icon icon--base icon--edit icon--primary'></i>
                                      </div>
                                    </div>
                                  </div>
                                );
                  ...
                  <AddChildSidebar closeSidebar={closeAddCardSidebar}
              ...
              <div className='layout--primary'>
                <div>
                        ...
                        <div className='row'>
                          <div className='col col-12 col-xl-6'>
                            <div className='flex'>
                              ...
                              <div
                                className='flex flex--col flex--jc--center ml-6'>
                                <h4
                                  className='type--md mb-2'>{t(`COMPLETE_TUTOR_PROFILE_CARD.TITLE`)}</h4>
                  ...
                  <div className='card--secondary card--secondary--alt'>
                    <div
                      className={`card--secondary__head flex--jc--space-between`}>
                      <h2
                        className='type--wgt--bold type--lg'>{t('DASHBOARD.TITLE')}</h2>
                    ...
                    <div className='card--secondary__body pl-3 pr-3'>
                      {userRole === RoleOptions.Tutor ? (
                        <div className='dashboard__requests tutor-intro-1'>
                          <div
                            className='type--color--tertiary mb-2'>{t('DASHBOARD.REQUESTS.TITLE')}</div>
                              ...
                              <React.Fragment key={key}>
                                {groupedPendingBookingsRequests[key].map((item: IBooking) => {
                                  if (item.inReschedule && item.lastSuggestedUpdateUserId !== userId) {
                                    ...
                                    return <PendingRescheduleRequestItem
                                      booking={item} />;
                      ...
                      <div className='row'>
                        <div
                          className='col col-12 col-xl-5  tutor-intro-4 student-intro-1'>
                          <div
                            className='type--color--tertiary mb-2'>{t('DASHBOARD.SCHEDULE.TITLE')}</div>
                          {todayScheduled.length > 0 ? (
                            <div
                              className='card--dashboard card--dashboard--brand mb-xl-0 mb-8 h2 h--150'>
                              <div className='flex--primary mb-2'>
                                ...
                                <div className='flex--shrink'>
                                  ...
                                  >
                                    <i
                                      className='icon icon--base icon--chevron-left icon--white'></i>
                                  </button>
                                  <button
                                  ...
                                  >
                                    <i
                                      className='icon icon--base icon--chevron-right icon--white'></i>
                                  </button>
                                </div>
                              </div>
                            ...
                            <div
                              className='card--dashboard card--dashboard--brand mb-xl-0 mb-8 h--150 flex flex--ai--start'>
                        ...
                        <div className='col col-12 col-xl-7 student-intro-2'>
                          <div
                            className='type--color--tertiary mb-2'>{t('DASHBOARD.MESSAGES.TITLE')}</div>
                            ...
                            <div className='card--dashboard h--150 '>
                              <div className='flex--primary mb-2 '>
                                ...
                                <div>
                                  ...
                                  >
                                    <i
                                      className='icon icon--base icon--chevron-left icon--primary'></i>
                                  </button>
                                  <button
                                    className='btn card--dashboard__btn'
                        ...
                        {groupedUpcomming && Object.keys(groupedUpcomming).length > 0 ? (
                          Object.keys(groupedUpcomming).map((key: string) => {
                            return (
                              <React.Fragment key={key}>
                                <div
                                  className='type--color--tertiary mb-2'>{t('DASHBOARD.BOOKINGS.TITLE')}</div>
                                <div className='flex--primary'>
                                  <div
                                    className='mb-4 mt-6 type--wgt--bold'>{key}</div>
                                  <div className='type--color--secondary'>
                          ...
                          <>
                            <div
                              className='type--color--tertiary mb-2'>{t('DASHBOARD.BOOKINGS.RECOMMENDED')}</div>
                            <div
                              className='filter flex flex--col flex--ai--center student-intro-3'>
                              <div
                                className='flex flex--wrap flex--center mb-3'>
                              ...
                              {isLoadingAvailableTutors || availableTutorsUninitialized ? (
                                ...
                                <div className='tutor-list__no-results mt-30'>
                                  ...
                                  <p
                                    className='tutor-list__no-results__subtitle'>
                ...
                {tutorHiLinkModalActive &&
                  <HiLinkModalForTutorIntro roomLink={tutorialRoomLink}
                ...
                >
                  <div className='flex--primary mb-2 mr-2'>
                    <div
                      className='type--color--tertiary'>{t('DASHBOARD.NOTIFICATIONS.TITLE')}</div>
                  ...
                  <div className='mr-2'>
                    {notificationsData?.content && notificationsData.content.find((x) => x.read === false) ? (
                      ...
                      <div
                        className='card--primary card--primary--shadow'>{t('DASHBOARD.NOTIFICATIONS.EMPTY')}</div>
                    )}
                    <div className='type--center mt-4'>
                      <Link to={t(PATHS.NOTIFICATIONS)}
