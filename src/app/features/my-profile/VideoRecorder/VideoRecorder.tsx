  ...
  return (
    <>
      <div className={className}>
        <div
          className='flex flex--row flex--jc--space-between flex--ai--center'>
            ...
            {recordedChunks.length > 0 && !capturing ? (
              <div>
                <video style={{ width: '100%', height: 'auto' }}
                       src={replayVideoUrl} controls></video>
              </div>
            ) : (
              <div className={''}>
                <Webcam
          ...
          <div className='flex flex--col w--50'>
            <div className={'w--300--min align--center'}>
              <h3
                className={'mb-4 type--center'}>{t('VIDEO_PREVIEW.RECORD_MODAL.SETTINGS')}</h3>
              ...
              {showStartingLoader ? (
                ...
                <>
                  ...
                  <div className={'flex flex--col'}>
                    ...
                    <MicrophoneTest className={'mb-1'}
                                    deviceId={selectedMicrophoneDevice} />
                    <Select
                      className={'mt-1'}
                      classNamePrefix='select'
                  ...
                  <div>
                    {!showLoader && !showProgressBar && (
                      <div>
                        <div
                          className={'flex flex--row flex--jc--space-between mb-2 mt-5'}>
                          {capturing ? (
                            <button
              ...
              <div className={'mt-2'}>
                {!showLoader && showProgressBar && (
                  <div className={'w--100 mt-4'}>
                    <h3
                      className={''}>{t('VIDEO_PREVIEW.LOADING.UPLOADING')}</h3>
                    <progress className={'w--100'} value={uploadProgress}
                              max='100' color={'#7e6cf2'} />
                  </div>
                )}
                ...
                {showLoader && (
                  <div>
                    <p
                      className={'mb-2'}>{t('VIDEO_PREVIEW.LOADING.PREPARING')}</p>
                    <SyncLoader color={'#7e6cf2'} loading={showLoader}
                                size={12} />
                  </div>
                )}
              </div>
