...
import { useAddPaymentIntentMutation, useLazyGetCustomerByIdQuery } from '../services/stripeService';
        ...
        <div>
            ...
            <div className={`sidebar sidebar--secondary sidebar--secondary ${!sideBarIsOpen ? 'sidebar--secondary--close' : ''}`}>
                ...
                <div className={'flex--grow mt-10'}>
                    <div className={'type--center type--wgt--extra-bold type--normal'}>{t('ACCOUNT.CARD_DETAILS.NOTE')}</div>
                </div>
