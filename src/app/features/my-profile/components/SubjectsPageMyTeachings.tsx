...
import {
  CreateSubjectCard,
} from '../../onboarding/tutorOnboardingNew/CreateSubjectCard';
...
const SubjectsPage = () => {
  ...
  const areSubjectsEqual = (subject1: ITutorSubject, subject2: ITutorSubject) => {
    return subject1.tutorId === subject2.tutorId &&
  ...
  const areArraysSame = (arr1: ITutorSubject[], arr2: ITutorSubject[]) => {
    ...
    return arr1.every(subject1 =>
      arr2.some(subject2 => areSubjectsEqual(subject1, subject2)),
    );
  };
