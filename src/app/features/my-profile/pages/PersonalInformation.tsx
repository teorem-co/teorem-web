              ...
              {(pageLoading && <LoaderPrimary/>) || (
                <>
                  <div className="card--profile__section">
                    <div>
                      <div
                        className="mb-2 type--wgt--bold">{t('MY_PROFILE.PROFILE_SETTINGS.TITLE')}</div>
                      <div
                        className="type--color--tertiary w--200--max">{t('MY_PROFILE.PROFILE_SETTINGS.DESCRIPTION')}</div>
                      <button
                  ...
                  <div className="card--profile__section">
                    <div>
                      <div
                        className="mb-2 type--wgt--bold">{t('MY_PROFILE.TRANSLATION.TITLE')}</div>
                      <div
                        className="type--color--tertiary w--200--max">{t('MY_PROFILE.TRANSLATION.SUBTITLE')}</div>
                    </div>
                    <div className="w--800--max">
                  ...
                  {userRole === RoleOptions.Tutor && isSuccessTutor && (
                    <div className="card--profile__section">
                      <div>
                        <div
                          className="mb-2 type--wgt--bold">{t('MY_PROFILE.TUTOR_DISABLE.TITLE')}</div>
                        <div
                          className="type--color--tertiary w--200--max">{t('MY_PROFILE.TUTOR_DISABLE.SUBTITLE')}</div>
                      </div>
                      <div className="w--800--max">
                        <div
