                                                                ...
                                                                <span className="d--ib">
                                                                    {tutorData.averageGrade && tutorData.averageGrade > 0
                                                                        ? tutorData.averageGrade
                                                                            ...
                                                                            : 0 + `(${tutorData.numberOfGrades} ${t('TUTOR_PROFILE.REVIEWS')} )`
                                                    ...
                                                    <div className="flex flex--center mt-6 ">
                                                        ...
                                                        {tutorData.minimumPrice ? (
                                                            <span className="d--ib ml-4 type--md">
                                                                {tutorData.minimumPrice}{' '}
                                                                <span className="type--color--tertiary">{tutorData.User.Country.currencyCode}</span>
                                                                ...
                                                                <span className="type--color--tertiary">
                                                                    /{t('SEARCH_TUTORS.TUTOR_PROFILE.HOUR')}
                                                                </span>
                                                            </span>
                                                        ) : (
