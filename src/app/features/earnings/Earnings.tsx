...
import { useLazyGetBookingInvoicesQuery, useLazyGetEarningsQuery, useLazyGetPayoutsQuery } from './services/earningsService';
            ...
            <div className="card--secondary">
                ...
                <div className="card--secondary__body" style={{ marginTop: '-35px' }}>
                    <div className="card--secondary__head">
                        ...
                        <ToggleButtonGroup color="info" value={alignment} exclusive size="small" onChange={handleChange} aria-label="Platform">
                            <ToggleButton value="week" onClick={() => setPeriodOfTime('WEEK')} style={{ fontSize: '11px' }}>
                                {t('EARNINGS.WEEK')}
                            </ToggleButton>
                            <ToggleButton value="month" onClick={() => setPeriodOfTime('MONTH')} style={{ fontSize: '11px' }}>
                                {t('EARNINGS.MONTH')}
                            </ToggleButton>
                            <ToggleButton value="year" onClick={() => setPeriodOfTime('YEAR')} style={{ fontSize: '11px' }}>
                                {t('EARNINGS.YEAR')}
                            </ToggleButton>
                            <ToggleButton value="all-time" onClick={() => setPeriodOfTime('ALLTIME')} style={{ fontSize: '11px' }}>
                                {t('EARNINGS.ALLTIME')}
                            </ToggleButton>
                        </ToggleButtonGroup>
                    </div>
                    <div className="row">
                        ...
                        <div className="col col-12 col-md-6 col-xl-3">
                            <div className="card--earnings">
                                <div className="card--earnings__title">
                                    {earningsData?.totalEarnings}.00 {getCurrencySymbol(countryId)}
                                </div>
                                        ...
                                        datasets: [
                                            {
                                                ...
                                                data: earningsData?.studentsGraph.map((item) => item.y),
                                                yAxisID: 'y1',
                                            },
                                            {
                                                type: 'bar' as const,
                                                ...
                                                data: earningsData?.bookingsGraph.map((item) => item.y),
                                                yAxisID: 'y1',
                                            },
                                            {
                                                type: 'line' as const,
                                                label: t('EARNINGS.REVENUE.GRAPH_LEGEND'),
                                                data: earningsData.earningsGraph.map((item: IGraph) => item.y),
                                                yAxisID: 'y',
                                                fill: true,
                                    ...
                                    options={{
                                        ...
                                        scales: {
                                            y: {
                                                ...
                                                beginAtZero: true,
                                                title: {
                                                    text: t('EARNINGS.REVENUE.GRAPH_LEGEND') + ` / ${getCurrencySymbol(countryId)}`,
                                                    display: true,
                                                },
                                                grid: {
                    ...
                    <div className="card--secondary__head">
                        ...
                        <ToggleButtonGroup color="info" value={alignment} exclusive size="small" onChange={handleChange} aria-label="Platform">
                            ...
                            <ToggleButton value="payouts" onClick={() => setTable('PAYOUTS')} style={{ fontSize: '11px' }}>
                                Payouts
                            </ToggleButton>
                            <ToggleButton value="bookings" onClick={() => setTable('BOOKINGS')} style={{ fontSize: '11px' }}>
                                Bookings
                            </ToggleButton>
                        </ToggleButtonGroup>
                    </div>
