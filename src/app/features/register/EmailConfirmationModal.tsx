...
const EmailConfirmatioPopup = () => {
    ...
    const [resendActivationEmailPost] = useResendActivationEmailMutation();
    ...
    return (
        <>
            <div className="trial">
                ...
                >
                    <button className={`btn btn--base btn--clear${disableButton && ' btn--disabled'}`}>
                        {t('EMAIL_CONFIRMATION_POPUP.CONFIRM_BUTTON')}
                    </button>
                </div>
            </div>
