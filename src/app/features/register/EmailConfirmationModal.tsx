    ...
    return (
        <>
            <div className="trial">
                ...
                <div className="btn btn--primary btn--lg mt-6 mb-4" onClick={() => console.log('click')}>
                    {t('EMAIL_CONFIRMATION_POPUP.EXPIRATION')}
                </div>
                <div onClick={() =>{history.push(PATHS.LOGIN);}}>
                    <button className="btn btn--base btn--clear">{t('EMAIL_CONFIRMATION_POPUP.CONFIRM_BUTTON')}</button>
                </div>
            </div>
