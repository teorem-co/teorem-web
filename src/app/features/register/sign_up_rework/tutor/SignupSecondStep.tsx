...
export const SignupSecondStep = ({ nextStep }: StepTwoProps) => {
    ...
    const selectedCountry = useAppSelector((state) => state.role.selectedCountry);
        ...
        if (formik.values.email && formik2.values.phoneNumber) {
            dispatch(
                setStepTwo({
                    ...
                    countryId: selectedCountry || 'da98ad50-5138-4f0d-b297-62c5cb101247', //if null set to croatia
                })
            );
            nextStep();
        }
