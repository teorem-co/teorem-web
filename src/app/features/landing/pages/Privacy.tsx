        ...
        <LandingWrapper>
            <>
                <div className="privacy">
                    <h1>Privacy Policy for Teorem Ltd</h1>
                    <p>
                        At Teorem, accessible from teorem.co, one of our main priorities is the privacy of our visitors. This Privacy Policy document
                        contains types of information that is collected and recorded by Teorem and how we use it.
                    </p>
                    ...
                    <p>
                        ...
                        information that they shared and/or collect in Teorem. This policy is not applicable to any information collected offline or
                    ...
                    <h2>Log Files</h2>
                    <p>
                        Teorem follows a standard procedure of using log files. These files log visitors when they visit websites. All hosting
                    ...
                    <p>
                        Like any other website, Teorem uses 'cookies'. These cookies are used to store information including visitors' preferences,
                    ...
                    <p>You may consult this list to find the Privacy Policy for each of the advertising partners of Teorem.</p>
                    <p>
                        Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used in their
                        respective advertisements and links that appear on Teorem, which are sent directly to users' browser. They automatically
                    ...
                    <p>Note that Teorem has no access to or control over these cookies that are used by third-party advertisers.</p>
                    <h2>Third Party Privacy Policies</h2>
                    <p>
                        Teorem's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult the respective
                    ...
                    <p>
                        Teorem does not knowingly collect any Personal Identifiable Information from children under the age of 13. If you think that
