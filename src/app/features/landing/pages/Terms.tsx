        ...
        <LandingWrapper>
            <>
                <div className="terms">
                    ...
                    <p>Welcome to Teorem!</p>
                    <p>These terms and conditions outline the rules and regulations for the use of Teorem Ltd's Website, located at teorem.co.</p>
                    <p>
                        By accessing this website we assume you accept these terms and conditions. Do not continue to use Teorem if you do not agree
                    ...
                    <p>
                        ...
                        of our assistance to the Client in the most appropriate manner for the express purpose of meeting the Client’s needs in
                        respect of provision of the Company’s stated services, in accordance with and subject to, prevailing law of Netherlands. Any
                        use of the above terminology or other words in the singular, plural, capitalization and/or he/she or they, are taken as
                    ...
                    <p>
                        We employ the use of cookies. By accessing Teorem, you agreed to use cookies in agreement with the Teorem Ltd's Privacy
                        Policy.{' '}
                    </p>
                    <p>
                    ...
                    <p>
                        Unless otherwise stated, Teorem Ltd and/or its licensors own the intellectual property rights for all material on Teorem. All
                        intellectual property rights are reserved. You may access this from Teorem for your own personal use subjected to restrictions
                        set in these terms and conditions.
                    </p>
                    <p>You must not:</p>
                    <ul>
                        <li>Republish material from Teorem</li>
                        <li>Sell, rent or sub-license material from Teorem</li>
                        <li>Reproduce, duplicate or copy material from Teorem</li>
                        <li>Redistribute content from Teorem</li>
                    </ul>
                    <p>
                    ...
                    <p>
                        ...
                        website. Teorem Ltd does not filter, edit, publish or review Comments prior to their presence on the website. Comments do not
                        reflect the views and opinions of Teorem Ltd,its agents and/or affiliates. Comments reflect the views and opinions of the
                        person who post their views and opinions. To the extent permitted by applicable laws, Teorem Ltd shall not be liable for the
                    ...
                    <p>
                        Teorem Ltd reserves the right to monitor all Comments and to remove any Comments which can be considered inappropriate,
                    ...
                    <p>
                        You hereby grant Teorem Ltd a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce and edit
                    ...
                    <p>
                        ...
                        us from the visibility of the hyperlink compensates the absence of Teorem Ltd; and (d) the link is in the context of general
                    ...
                    <p>
                        If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website, you must inform
                        us by sending an e-mail to Teorem Ltd. Please include your name, your organization name, contact information as well as the
                        URL of your site, a list of any URLs from which you intend to link to our Website, and a list of the URLs on our site to which
                    ...
                    <ul>
                        ...
                        <li>
                            By use of any other description of our Website being linked to that makes sense within the context and format of content
                            on the linking party’s site.
                        </li>
                    </ul>
                    <p>No use of Teorem Ltd's logo or other artwork will be allowed for linking absent a trademark license agreement.</p>
                    <h3>
                    ...
                    <p>
                        If you find any link on our Website that is offensive for any reason, you are free to contact and inform us any moment. We
                        will consider requests to remove links but we are not obligated to or so or to respond to you directly.
                    </p>
                    <p>
