    ...
    <MainWrapper>
      <div className='card--secondary' ref={cardRef}>
        <div
          ...
          <div className='flex flex--center search-container'
               style={{ position: 'relative' }}>
            <i
              className='icon icon--md icon--search icon--black search-icon'></i>
            <input
              ref={searchInputRef}
              type='text'
                      ...
                      <td className='menu-container'>
                        ...
                        <div className='tutor-list-menu'>
                          ...
                          >
                            ...
                            <p
                              className={tutor.verified ? 'ml-2 text-red' : 'ml-2 text-green'}>
                          ...
                          >
                            ...
                            <p
                              className='ml-2'>{t('TUTOR_MANAGMENT.ACTIONS.DELETE')}</p>
                          </button>
                        </div>
                      </td>
                    )}
      ...
      <div className={`modal tutor--managment ${closeModal && 'closed'}`}>
        <div
          className='tutors--table--tab--select card--secondary__head card--secondary__head--search-tutor'>
          <div
            className='type--md type--wgt--bold mb-4 mb-xl-0'>{t('TUTOR_MANAGMENT.TITLE')}</div>
          <p
            className='type--color--secondary mb-3 mb-xl-0'>{selectedTutor?.email}</p>
        </div>
        <div className='card--secondary__body tutor-managment-card'>
          <p
