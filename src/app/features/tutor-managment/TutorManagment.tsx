...
const TutorManagment = () => {
    ...
    const [searchTutors, { isLoading: isLoadingSearchTutors, isFetching: searchTutorsFetching }] = useLazySearchTutorsQuery();
    ...
    const [deleteTutor, { isSuccess: isSuccessDeleteTutors }] = useDeleteTutorMutation();
    ...
    return (
        <MainWrapper>
                                ...
                                <tbody className="table-scrollable-tbody">
                                    ...
                                    {loadedTutorItems.map((tutor: ITutorAdminSearch, key) => (
                                        <tr key={key}>
                                            ...
                                            >
                                                <img className="react-select__flag" src={tutor.countryFlag} />
                                                {tutor.countryName}
                                            </td>
                                            <td
                                                onClick={() => {
                                            ...
                                            {tutor.verified == null ? (
                                                <td className="approve-deny">
                                                    <button className="btn btn--base btn--clear" onClick={() => approveTutor(tutor.userId)}>
                                                        {t('TUTOR_MANAGMENT.ACTIONS.APPROVE')}
                                                    </button>
                                                    <button className="btn btn--base btn--ghost" onClick={() => handleDenyTutor(tutor)}>
                                                        {t('TUTOR_MANAGMENT.ACTIONS.DECLINE')}
                                                    </button>
                                                </td>
                                            ) : (
                                                <td className="menu-container">
                                                    <Link to={PATHS.TUTOR_MANAGMENT_TUTOR_PROFILE.replace(':tutorSlug', tutor.slug)}>
                                                    ...
                                                    <div className="tutor-list-menu">
                                                        ...
                                                        >
                                                            ...
                                                            <p className={tutor.verified ? 'ml-2 text-red' : 'ml-2 text-green'}>
                                                                {!tutor.verified ? t('TUTOR_MANAGMENT.ACTIONS.APPROVE') : 'Suspend'}
                                                            </p>
                                                        </button>
                                                        <button
                                                            className="btn btn--base btn--clear"
                                                            onClick={() => {
                                                                deleteTutor(tutor.userId);
                                                            }}
                                                        >
            ...
            <Sidebar
                    ...
                    <div className="card--secondary__body tutor-managment-card">
                        ...
                        <button
                            ...
                            onClick={async () => {
                                await denyTutor({
                                    tutorId: selectedTutor?.userId,
                                    message: editNoteRef?.current?.value || '',
                                });
                                setSelectedTutor(undefined);
                            }}
                        >
                ...
                onSubmit={() => {
                    approveTutor(selectedTutor?.userId);
                }} //: () => void;
                onCancel={() => {
                    deleteTutor(selectedTutor?.userId);
                }} //: () => void;
