        ...
        if (typeof column === 'boolean') {
            return (
                <td key={index} className={`${column ? 'table--availability--check' : 'table--availability--close'}`}>
                    <i
                        className={`icon icon--base ${column ? 'icon--check icon--primary' : 'icon--close icon--grey'} `}
                    ></i>
                </td>
            );
        } else if (column == '') {
        ...
        <MainWrapper>
                            ...
                            >
                                <div className="card--secondary__head">
                                    <div className="flex flex--center">
                                        ...
                                        <p className={'type--center type--lg ml-1'}>{getVerifiedMessage()}</p>
                                    </div>
                                </div>
                                            ...
                                            <table className="table table--availability">
                                                <tbody>
                                                    {tutorAvailability.map(
                                                        (row: (string | boolean)[], index: number) => {
                                                            return (
                                                                <tr key={index}>
                                                                    {row.map(
                                                                        (column: string | boolean, index: number) => {
                                            ...
                                            <div className="reviews-list">
                                                <div className="type--center mt-22">
                                                    ...
                                                    <p className="type--color--secondary">
                                                        {t('MY_REVIEWS.NO_RESULT.DESC_ADMIN')}
                                                    </p>
                                                </div>
                                            </div>
                                        )}
                                ...
                                <div className="mt-10 mb-10">
                                    ...
                                    <div className="flex--primary">
                                        <div>
                                            ...
                                            <span className="d--ib ml-2 type--color--secondary">
                                                {t('TUTOR_PROFILE.COMPLETED_LESSONS')}:
                                            </span>
                                        </div>
                                        <span className="d--ib ml-4">
                                            {/* Add later */}
                                    ...
                                    <div className="flex--primary mt-4">
                                        <div>
                                            <i className="icon icon--info icon--base icon--grey"></i>
                                            <span className="d--ib ml-2 type--color--secondary">
                                                {t('TUTOR_PROFILE.ID_VERIFIED')}:
                                            </span>
                                        </div>
                                        <span className="d--ib ml-4">
                                            {tutorData.idVerified ? (
                                                ...
                                                <i className={'icon icon--base icon--close'} />
                                            )}
                                        </span>
                                    </div>
                                    ...
                                    <div className="flex--primary">
                                        <div>
                                            ...
                                            <span className="d--ib ml-2 type--color--secondary">
                                                {t('TUTOR_PROFILE.DOCUMENTS_UPLOADED')}:
                                            </span>
                                        </div>
                                        <span className="d--ib ml-4">
                                            {tutorData.stripeDocumentsUploaded ? (
                                                <i className={'icon icon--base icon--check'} />
                                            ) : (
                                                <i className={'icon icon--base icon--close'} />
                                            )}
                                ...
                                {userRole !== RoleOptions.Tutor && (
                                    <>
                                        ...
                                        {tutorData.User.stripeConnected && (
                                            <DisconnectStripe tutorId={tutorData.User.id} setRefetch={setRefetch} />
                                        )}
                                        ...
                                        <div className="flex flex--row flex--jc--space-around mt-2">
            ...
            <div className={`modal tutor--managment ${closeModal && 'closed'}`}>
                <div className="tutors--table--tab--select card--secondary__head card--secondary__head--search-tutor">
                    <div className="type--md type--wgt--bold mb-4 mb-xl-0">{tutorData?.User.firstName}</div>
                </div>
                <div className="card--secondary__body tutor-managment-card">
                    ...
                    <textarea placeholder={t('TUTOR_MANAGMENT.NOTE_PLACEHOLDER')} ref={noteRef}></textarea>
                </div>
                {!tutorDenySent ? (
                    <div className="card--secondary__body tutor-managment-card">
                        <button
