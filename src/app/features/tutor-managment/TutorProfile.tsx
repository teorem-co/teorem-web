              ...
              <div onScroll={(e: any) => debouncedScrollHandler(e.target)} className="card--secondary card--secondary--alt">
                ...
                <div className="card--secondary__body">
                  ...
                  <div className="mb-10">
                    ...
                    <div className="type--color--secondary type--break">
                      {tutorData && tutorData.aboutLessons ? tutorData.aboutLessons : <>{t('SEARCH_TUTORS.TUTOR_PROFILE.EMPTY_STATE_LESSON')}</>}
                    </div>
                  </div>
                  <div className="mb-10">
                  ...
                  <div className="mb-10">
                    ...
                    <div className="flex flex--jc--space-between">
                      <div>
                        <div className="type--huge">{tutorStatistics?.statistic ? tutorStatistics.statistic.toFixed(1) : 0}</div>
                        <div className="rating__stars mb-4">
                          <div
                            className="rating__stars__fill"
                            style={{
                              width: `${tutorStatistics && tutorStatistics.statistic ? handleRatingStars(tutorStatistics.statistic) : 0}px`,
                            }}
                          ></div>
                        </div>
                    ...
                    {myReviews && myReviews.rows.length > 0 ? (
                      <>
                        <div className="reviews-list">
                          {loadedMyReviews && loadedMyReviews.map((item: IMyReview, index: number) => <ReviewItem key={index} reviewItem={item} />)}
                        </div>
                        {/* {hideLoadMore() ? (
                                                    <></>
                                                ) : (
