              ...
              >
                ...
                {userRole !== RoleOptions.Parent && (
                  <div className='mt-10 mb-10 ml-6 mr-6'>
                    <span
                      className='type--uppercase type--color--tertiary'>{t('COMPLETED_LESSONS.LESSONS_AVAILABLE')}</span>
                    ...
                    <>
                      <div className={`lessons-list__item mt-6`}>
                        <div className='lessons-list__item__info'>
                          <div
                            className='type--wgt--bold'>{t('COMPLETED_LESSONS.EMPTY_LESSONS_TITLE')}</div>
                          <div
                            className='type--color--brand'>{t('COMPLETED_LESSONS.EMPTY_LESSONS_LIST')}</div>
                        </div>
                      </div>
                    </>
                  )}
                ...
                {activeLesson && studentCompletedBookings.length > 0 ? (
                        ...
                        <div>
                          ...
                          >
                            <ButtonPrimaryGradient
                              className={'btn btn--base border-button'}>
                          ...
                          return (
                            <React.Fragment key={index}>
                              {(index === 0 || currentMonth !== previousMonth) && (
                                <div
                                  className='text-align--center mb-4 mt-2 primary-color'>
                                  {currentMonth} {moment(booking.startTime).year()}
                                </div>
                              )}

                              <StudentBookingInfoItem bookingInfo={booking}
                                                      activeLesson={activeLesson} />
                            </React.Fragment>
                          );
                        })}
                  ...
                  <>
                    <div className='tutor-list__no-results'>
                      <h1
                        className='tutor-list__no-results__title'>{t('COMPLETED_LESSONS.EMPTY_LESSONS_TITLE')}</h1>
                      <p
                        className='tutor-list__no-results__subtitle'>{t('COMPLETED_LESSONS.EMPTY_VIDEOS')}</p>
                      <Link className='btn btn--clear ml-6 type--wgt--bold'
                            to={t('PATHS.MY_BOOKINGS')}>
                      ...
                      <div>
                        ...
                        <div className=' flex--jc--space-between'>
                          <div className='flex flex--center mb-6'>
                            ...
                            <div
                              className='type--center align--center flex--grow'>
                              <Link
                                className='text__no-decoration'
                                to={`${PATHS.SEARCH_TUTORS_TUTOR_PROFILE.replace(
                                  ':tutorSlug',
