    ...
    return (
        <>
            <MainWrapper>
                    ...
                    <div className="card--lessons__body">
                        <div className="card--lessons__body__aside">
                            <div className="mt-10 mb-10 ml-6 mr-6">
                                <span className="type--uppercase type--color--tertiary">{t('COMPLETED_LESSONS.TUTORS_AVAILABLE')}</span>
                                    ...
                                    <div>
                                        <div className="flex--primary">
                                            ...
                                            <div>
                                                ...
                                                <button className="btn btn--base btn--primary">{t('COMPLETED_LESSONS.VIEW_CALENDAR')}</button>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="mt-10">
                ...
                {activeReviewModal ? <ReviewModal tutorId="asd" handleClose={() => setActiveReviewModal(false)} /> : <></>}
            </MainWrapper>
        </>
    );
};
