                                ...
                                <div onScroll={(e: any) => debouncedScrollHandler(e.target)} className="card--secondary card--secondary--alt">
                                        ...
                                        <div className="tutor-list__item__img">
                                            {props.profileImage || tutorData?.User.profileImage ? (
                                                <img
                                                    ...
                                                    src={`${
                                                        props.profileImage ? props.profileImage : tutorData?.User.profileImage + `&v=${cacheBuster}`
                                                    }`}
                                    ...
                                    <div className="card--secondary__body">
                                        ...
                                        <div className="mb-10">
                                            ...
                                            <div className="type--color--secondary type--break">
                                                {props.aboutLessons ? props.aboutLessons : <>{t('SEARCH_TUTORS.TUTOR_PROFILE.EMPTY_STATE_LESSON')}</>}
                                            </div>
                                        </div>
                                        <div className="mb-10">
                                        ...
                                        >
                                            ...
                                            <table style={{ width: '100%', textAlign: 'center' }} className="table table--primary">
                                                <thead>
