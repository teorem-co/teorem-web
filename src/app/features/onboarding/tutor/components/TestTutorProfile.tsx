...
import { useLazyGetTutorByIdQuery, useLazyGetTutorByTutorSlugQuery } from '../../../../store/services/tutorService';
...
const TestTutorProfile = (props: Props) => {
    ...
    const [getTutorProfileData, { data: tutorData, isLoading: tutorDataLoading }] = useLazyGetTutorByIdQuery();
    ...
    useEffect(() => {
        if (tutorId) getTutorProfileData(tutorId);
    }, []);
                                ...
                                >
                                    <div className="card--secondary__head flex flex--row flex--ai--center flex--jc--space-around w--100 mb-5">
                                        ...
                                        <div className="flex flex--col w--80">
                                            ...
                                            <div className="type--color--brand type--sm type--center type--break">
                                                {tutorData.currentOccupation || props.occupation}
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    {tutorData.TutorSubjects.length > 0 ? (
                                                        tutorData.TutorSubjects.map((item: ITutorSubjectLevel) => {
                                                            return (
                                                                <tr
                                                                    key={item.id}
                                                                    className={`type--left ${isMobile ? 'type--sm p-0' : ''}`}
                                                                >
                                                                    <td>
                                                                        {t(
                                                                    ...
                                                                    'IB (International Baccalaurate)' ? (
                                                                        ...
                                                                        <td>
                                                                            {t(
                                                                                `LEVELS.${item.Level.name.replaceAll('-', '').replaceAll(' ', '').toLowerCase()}`
                                                                            )}
                                                                        </td>
                                                                    )}
                                                                    <td>
