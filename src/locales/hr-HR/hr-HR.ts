export const HR_HR = {
    ...
    FORM_VALIDATION: {
        ...
        SPECIAL_CHAR: 'Sadržavati barem jedan posebni znak (@, $, !, %, *, ?, &...)',
    ...
    ROLE_SELECTION: {
        ...
        PARENT_DESCRIPTION: 'Ovdje sam zbog svojeg djeteta.',
    ...
    MY_BOOKINGS: {
        ...
        MODAL: {
            ...
            ACCEPT: 'Prihvati',
            PROPOSE: 'Predložite novo vrijeme',
            DELETE: 'Izbriši',
            DENY: 'Odbij',
        ...
        INFORMATION: {
            ...
            CARD2: {
                ...
                DESC: 'Možete otkazati rezervaciju u Vašem kalendaru klikom na rezervaciju te potom na "Otkaži". Ako otkažete rezervaciju više od 24 sata unaprijed, dobit ćete puni povrat novca.',
            },
        },
    },
    BOOK: {
    ...
    COMPLETE_PROFILE: {
        ...
        DESCRIPTION: 'Ispunite podatke koji nedostaju kako biste završili svoj profil',
    ...
    HOW_IT_WORKS: {
        ...
        TEXT_CARD_3: {
            ...
            SUBTITLE:
                'Naša predavanja su toliko više od videopoziva. Naša virtualna učionica sadrži digitalnu bijelu ploču, funkciju snimanja, dijeljenje zaslona i još mnogo toga.',
        },
        TEXT_CARD_4: {
    ...
    BECOME_A_TUTOR: {
        ...
        REVIEW_1: {
            TEXT: 'Teorem mi pomaže da se manje brinem o ocjenama svoje djece. Teoremovi stručni instruktori pomogli su mojoj djeci ostvariti bolje ocjene, što im je uvelike podiglo samopouzdanje!',
            NAME: 'John',
            OCCUPATION: 'Otac troje djece',
        },
        REVIEW_2: {
            TEXT: 'Besplatne konzultacije omogućile su mi da razgovaram s nekoliko instruktora prije nego odlučim koji instruktor najbolje odgovara potrebama mojega djeteta. Ne mogu biti sretnija!',
            NAME: 'Renata',
            OCCUPATION: 'Samohrana majka',
        },
